    ...
    <section className={styles.hero} id="top">
      <div className={styles.content}>
        ...
        <div className={styles.social}>
          <a href="https://x.com/YOUR_HANDLE" target="_blank" rel="noreferrer" aria-label="X (Twitter)">
            <XIcon />
          </a>
          <a href="https://www.linkedin.com/in/treena-dutta-%20majumdar/" target="_blank" rel="noreferrer" aria-label="LinkedIn">
            <LinkedInIcon />
          </a>
          <a href="https://github.com/YOUR_HANDLE" target="_blank" rel="noreferrer" aria-label="GitHub">
            <GitHubIcon />
          </a>
          <a href="https://substack.com/@treenaduttamajumdar" target="_blank" rel="noreferrer" aria-label="Substack">
            <SubstackIcon />
          </a>
        </div>
      </div>
